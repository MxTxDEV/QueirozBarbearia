  ...
  return (
    ...
    >
      <div className="relative h-32 w-full shrink-0 overflow-hidden bg-gradient-to-br from-secondary-dark/40 to-accent-dark/30">
        ...
        {/* Logo 100% dentro da capa (nunca sobra pra fora dela). */}
        <div className="absolute bottom-3 left-3 flex h-14 w-14 items-center justify-center overflow-hidden rounded-2xl border-2 border-background bg-white p-1.5 shadow-lg">
          <CompanyLogo logoUrl={company.logoUrl} name={company.name} height={36} className="max-w-[48px] text-neutral-900" />
        </div>
      </div>
