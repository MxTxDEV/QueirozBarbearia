...
export function NotificationsBell({
  ...
  return (
    <div className="relative">
      <button
        className="relative rounded-xl p-2 text-foreground-muted transition-colors hover:bg-white/5 hover:text-foreground"
            ...
            <div className="max-h-80 overflow-y-auto">
              ...
              {notifications.map((n) => (
                <div
                  key={n.id}
                  className={cn(
                    "rounded-xl px-3 py-2 text-sm transition-colors hover:bg-white/5",
